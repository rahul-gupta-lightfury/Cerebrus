...
class ThemeManager:
    ...
    def _create_themes(self):
        # Standard Palette
        self._create_theme_variant("Standard", "Dark", {
        ...
        self._create_theme_variant("Standard", "Light", {
        ...
        self._create_theme_variant("High Contrast", "Dark", {
        ...
        self._create_theme_variant("High Contrast", "Light", {
        ...
        # Dark
        self._create_theme_variant("Deuteranopia", "Dark", {
        ...
        # Light
        self._create_theme_variant("Deuteranopia", "Light", {
        ...
        # Dark
        self._create_theme_variant("Tritanopia", "Dark", {
        ...
        # Light
        self._create_theme_variant("Tritanopia", "Light", {
    ...
    def get_log_colors(self):
        ...
        if palette == "Deuteranopia":
            ...
            return {
                ...
                "WARNING": (255, 255, 100) if mode == "Dark" else (200, 180, 0), # Yellow
                "ERROR": (200, 200, 200) if mode == "Dark" else (50, 50, 50), # Grey/White (Avoid Red) - Actually user wants distinct. 
                ...
                "SUCCESS": (255, 255, 0) if mode == "Dark" else (200, 180, 0), # Yellow (Success/Warning might clash? Let's make Success brighter)
            }
            ...
            return {
                ...
                "WARNING": (255, 200, 200) if mode == "Dark" else (200, 100, 100), # Light Red
