...
DEFAULT_PROFILE = ProfileConfig(name="default", report_type="summary", nickname="Default Profile")
DEFAULT_CONFIG = AppConfig(version=1, tool_paths={}, profiles=[DEFAULT_PROFILE], cache=DEFAULT_CACHE)
